...
@section('content')
    ...
    <form class="col col-lg-6 mx-auto align-items-center p-4 rounded shadow bg-light" action="{{ route($voiture->exists ? 'admin.voiture.update' : 'admin.voiture.store', $voiture)}}" method="POST">
        ...
        <div class="mb-3">
            ...
            @include('shared.input', ['label' => 'Désignation', 'name' => 'Design', 'id' => 'Design', 'value' => $voiture->Design])
