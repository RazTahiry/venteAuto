...
@section('content')
    ...
    <form class="col col-lg-6 mx-auto align-items-center p-3 border rounded shadow-sm bg-light" action="{{ route($client->exists ? 'admin.client.update' : 'admin.client.store', $client)}}" method="post">
